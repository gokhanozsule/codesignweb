...
export function Villa01_Partial(props) {
  ...
  const { nodes, materials } = useGLTF(`${basePath}models/Villa01_Partial.glb`)
  return (
    <group {...props} dispose={null}>
      ...
      <group rotation={[0, 1.571, 0]} scale={[0.965, 1, 1]}>
        ...
        <mesh
          ...
          material={materials['rangemaster_contemporary_oven_r6012_large 594x594x535']}
        />
        <mesh
          castShadow
          receiveShadow
      ...
      <group position={[0.208, 0.119, 2.27]} rotation={[0, 0, -Math.PI]} scale={-1}>
        <mesh
          castShadow
          receiveShadow
...
const basePath = import.meta.env.VITE_BASE_URL === '/codesignweb/' ? '' : import.meta.env.VITE_BASE_URL;
useGLTF.preload(`${basePath}models/Villa01_Partial.glb`)