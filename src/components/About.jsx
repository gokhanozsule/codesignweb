...
const About = () => {
  return (
    <>
    <div className='w-full h-full rounded-3xl bg-cover bg-center custom-shadow mb-4 z-10 flex flex-col relative select-none'
    ...
    >
      <div className="w-full h-full bg-black opacity-45 absolute left-0 right-0"></div>
        ...
        <div className='flex flex-row h-full w-full justify-between pr-24 pl-24 relative'>
          <div className='flex flex-col h-full justify-start items-center text-center w-full text-white'>
            <div className='flex w-full text-xs pt-12 '>
              GOKHAN OZSULE
            </div>
            ...
            <a href="https://www.joali.com/joali-being/" target='_blank' className='flex w-full text-sm text-red-400'  >
            ...
            <a href="https://www.emaarsquaremall.com/en/" target='_blank' className='flex w-full text-sm text-red-400'  >
          ...
          <div className='flex flex-col h-full justify-center items-center text-center w-full text-white'>
            <div className='flex flex-col justify-start items-end h-full w-full text-2xl pt-24'>
              ...
              <p className='flex w-full items-end text-end justify-end text-base pt-1'>
