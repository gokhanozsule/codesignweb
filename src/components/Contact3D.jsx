    ...
    <>
      <group ref={group} {...props} dispose={null}>
        ...
        <group
          rotation={[0, 0.441, 0]}
          scale={0.707}
          onClick={() => setHoveredIco(true)}
          onPointerEnter={() => setHoveredCo(true)}
          onPointerLeave={() => setHoveredCo(false)}
        >
          <mesh
            castShadow
            receiveShadow
        ...
        {contactOpen && (
          <Html
            as="div"
            fullscreen
            className="bg-black flex flex-col justify-center items-center rounded-3xl cursor-default"
          >
            <div
        ...
        <group visible={true}>
          <group
            scale={0.1}
            visible={true}
            onClick={handleColorGreen}
            onPointerEnter={() => setHoveredGreen(true)}
            onPointerLeave={() => setHoveredGreen(false)}
          >
            <mesh
              castShadow
              receiveShadow
          ...
          <group
            ...
            onPointerEnter={() => setHoveredRed(true)}
            onPointerLeave={() => setHoveredRed(false)}
          >
            <mesh
              castShadow
              receiveShadow
          ...
          <group
            scale={0.1}
            visible={true}
            onClick={handleColorBlue}
            onPointerEnter={() => setHoveredBlue(true)}
            onPointerLeave={() => setHoveredBlue(false)}
          >
            <mesh
              castShadow
              receiveShadow
          ...
          <group
            visible={true}
            onClick={handleColorGray}
            onPointerEnter={() => setHoveredGray(true)}
            onPointerLeave={() => setHoveredGray(false)}
          >
            <mesh
              castShadow
              receiveShadow
