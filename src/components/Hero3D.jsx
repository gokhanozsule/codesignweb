...
import { DoubleSide, MeshPhysicalMaterial, RGBAFormat } from 'three'
import bg from '../images/07.png'
import bg01 from '../images/06.png'
import bg02 from '../images/08.png'
...
export function Hero3D(props) {
  ...
  useEffect(() => {
    document.body.style.cursor = hovered || hoveredAbout || hoveredWorks ? "pointer" : "auto"
  ...
  return (
    ...
    <group ref={group} {...props} dispose={null}>
      ...
      <group position={[1, 0.025, 0]} >
        ...
        >
        <meshPhysicalMaterial color={emmissiveColor} emissive={emmissiveColor} emissiveIntensity={emmissiveIntensity}/>
        </mesh>
      </group>
      ...
      >
        <meshPhysicalMaterial color={"lightgray"} metalness={1} roughness={0.25}/>
      </mesh>
      <mesh 
        castShadow
        receiveShadow
      ...
      <mesh
        ...
        scale={[2.281, 1.161, 0.775]}
      >
        <meshPhysicalMaterial color={"lightgray"} metalness={1} roughness={0.3}/>
      </mesh>
      <mesh
        castShadow
        receiveShadow
      ...
      <group position={[-1.3, 1.795, 0.409]} >
        ...
        >
          <meshPhysicalMaterial color={"#d6cbb9"} roughness={0.15} side={DoubleSide} />
        </mesh>
        <mesh
          castShadow
          receiveShadow
        ...
        >
          <meshPhysicalMaterial emissive={emmissiveColor} emissiveIntensity={emmissiveIntensity}/>
        </mesh>
      </group>
      ...
      {/* banyo kuvet */}
      <group position={[-1.839, 1.877, 2.225]} rotation={[0, 1.571, 0]} scale={0.75} >
      ...
      <group position={[0.879, 1.805, 2.273]}>
        <group position={[-0.194, 0.053, -0.246]} rotation={[0, 0.685, 0]} scale={0.625}>
          <mesh
            castShadow
            receiveShadow
        ...
        <group position={[0.926, 0.053, -0.246]} rotation={[0, -0.886, 0]} scale={0.625}>
          <mesh
            castShadow
            receiveShadow
            geometry={nodes['C-Box007#1_1'].geometry}
      ...
      {/* office desk */}
      <group position={[2.849, 1.822, -0.213]} rotation={[0, 1.571, 0]} scale={0.625}>
      ...
      <group position={[3.85, 1.822, 1.044]} >
        <group position={[-0.283, 0.298, -1.352]} rotation={[-Math.PI / 2, 0, 2.44]} scale={-0.625}>
          <mesh
            castShadow
            receiveShadow
        ...
        <group position={[-0.283, 0.298, -0.653]} rotation={[Math.PI / 2, 0, -0.887]} scale={0.625}>
          <mesh
            castShadow
            receiveShadow
            geometry={nodes['G-Object014_1'].geometry}
      ...
      <mesh
        ...
        scale={[0.737, 1, 0.5]}
      >
        <meshPhysicalMaterial color={"lightgray"} metalness={1} roughness={0.3} side={DoubleSide}/>
      </mesh>
      ...
      <group position={[2.862, 2.26, -0.428]} scale={0.625}>
        <group position={[-1.323, 0, -1.664]}>
          <group position={[1.329, 0.018, 1.661]}>
            <group position={[0.019, 0.025, 0.014]} rotation={[-0.629, -0.951, -0.535]}>
              <mesh
                castShadow
                receiveShadow
      ...
      >
        <meshPhysicalMaterial transparent={true} wireframe emissive={hovered? "lime" : "black" } thickness={.75}
                              color={hovered? "lime" : "white" } opacity={0.9} roughness={0.25} metalness={ hovered ? 0 : 1}
                              />
      </mesh>
      <mesh
        castShadow
        ...
        onClick={() => setContact(true)}
      >
        <meshPhysicalMaterial transparent={true} wireframe={hovered} emissive={hovered? "lime" : "orange" } thickness={.75}
                              color={hovered? "lime" : "gray" } opacity={0.75} roughness={0.25} metalness={ hovered ? 0 : 1}
                              />
      </mesh>

      {hovered && !contact && <Html position={[-2, 0.45, 2.55]} >
        <div className='bg-slate-700/75 text-white border border-white px-2 p-1 rounded-full cursor-pointer' onClick={() => setContact(true)}>
        Contact
        </div>
      </Html>}

      {contact && <Html as='div' fullscreen className='flex flex-col justify-center items-center rounded-3xl cursor-default select-none relative z-20' >
      <div className='h-[65%] rounded-3xl z-20 border mb-16 bg-cover bg-center w-[75%] flex flex-col -translate-x-[8%] -translate-y-[25%] '
      ...
      >
      <meshPhysicalMaterial transparent={true} wireframe emissive={hoveredAbout ? "lime" : "black"} emissiveIntensity={1.5}
                            color={hoveredAbout ? "lime" : "white" } opacity={0.95} roughness={0.25} metalness={1}
                            />
      </mesh>
      <mesh 
        castShadow
        ...
        onClick={() => setAbout(true)}
      >
      <meshPhysicalMaterial transparent={true} wireframe={hoveredAbout} emissive={hoveredAbout ? "lime" : "orange"} emissiveIntensity={1.5}
                            color={hoveredAbout ? "lime" : "gray" } opacity={0.75} roughness={0.25} metalness={1}
                            />
      </mesh>
      {hoveredAbout && <Html position={[3.5, 0.3, -0.65]} >
      ...
      <Html fullscreen className='-translate-y-[15%]'> 
        <>
        <div className='w-[95%] h-[95%] rounded-3xl border border-white bg-cover bg-center custom-shadow mb-4 z-10 flex flex-col relative select-none translate-x-[5%] -translate-y-[11%]'
          ...
          <div className="w-full h-full bg-black opacity-45 absolute left-0 right-0 rounded-3xl"></div>
            ...
            <div className='flex flex-row h-full w-full justify-between pr-10 lg:pr-24 pl-10 sm:pl-24 relative'>
              <div className='flex flex-col h-full justify-start items-start text-start w-full text-white'>
                ...
                <a href="https://www.joali.com/joali-being/" target='_blank' className='flex w-full text-xs lg:text-sm text-red-400'  >
                ...
                <a href="https://www.emaarsquaremall.com/en/" target='_blank' className='flex w-full text-xs lg:text-sm text-red-400'  >
              ...
              <div className='absolute h-[85%] w-1/4 bottom-[5%] left-[37.5%] flex justify-center items-end rounded-3xl z-10 cursor-pointer'>
                <Canvas camera={{position:[0,1,6]}} dpr={[1.5, 2]} linear shadows>
                  <OrbitControls enablePan={false} enableZoom={false} 
                            ...
                            minAzimuthAngle={-Math.PI /8} maxAzimuthAngle={Math.PI /3}
                            />
      ...
      >
      <meshPhysicalMaterial transparent={true} wireframe emissive={hoveredWorks? "lime" : "black"} emissiveIntensity={1.5}
                            color={hoveredWorks ? "lime" : "white" } opacity={0.95} roughness={0.25} metalness={1}
                            />
      </mesh>
      <mesh 
        castShadow
        ...
        onClick={() => setWorks(true)}
      >
      <meshPhysicalMaterial transparent={true} wireframe={hoveredWorks} emissive={hoveredWorks? "lime" : "orange"} emissiveIntensity={1.5}
                            color={hoveredWorks ? "lime" : "gray" } opacity={0.75} roughness={0.25} metalness={1}
                            />
      </mesh>
      {hoveredWorks && <Html position={[2.75, 2.5, 0.25]} >
        <div className='bg-slate-700/75 text-white border border-white px-2 p-1 rounded-full cursor-pointer'>
        Works
        </div>
      </Html> 
      ...
      {works && 
        <Html fullscreen>
          <div className='w-[90%] h-[97%] rounded-3xl bg-cover bg-center custom-shadow z-10 flex flex-col relative translate-x-28 -translate-y-[75px] select-none'
          ...
          >
            ...
            <button className=' absolute border rounded-full w-6 h-6 flex justify-center items-center ml-4 mt-4 hover:bg-slate-400 text-white z-30'
                    onClick={() => {setWorks(!works)}}
            >
              X
            </button>
              ...
              <div className='w-full flex h-full'>
                <div className='w-1/2 h-1/2 '>
                  <div className='flex flex-col h-full justify-center items-center text-center w-full border rounded-3xl border-white'>
                    <ProjectCard to={'/MixedUse'} text={"MIXED USE DEVELOPMENT"} src={render01} />
                    <div className='text-white'>
                    2022 
                    </div>
                  </div>
                  <div className='flex flex-col h-full justify-center items-center text-center w-full border rounded-3xl border-white'>
                  <ProjectCard to={'/V01'} text={"PRIVATE VILLA"} src={render02}/>
                    <div className='text-white'>
                      2024
                    </div>
                  </div>
      ...
      <group position={[-0.423, 0.302, -1.335]} rotation={[0, -0.459, 0]} scale={0.025}>
        <mesh
          castShadow
          receiveShadow
          geometry={nodes['Component2#1_1'].geometry}
          material={materials['设计师SING的模型专用贴图(QQ群号：469733580) (339)2']}
        />
        <mesh
          castShadow
          receiveShadow
        ...
        <mesh
          ...
          material={materials['设计师SING的模型专用贴图(QQ群号：469733580) (3']}
        />
        <mesh
          castShadow
          receiveShadow
          geometry={nodes['Component2#1_6'].geometry}
          material={materials['设计师SING的模型专用贴图(QQ群号：469733580) (3.006']}
        />
        <mesh
          castShadow
          receiveShadow
        ...
        <mesh
          ...
          material={materials['设计师SING的模型专用贴图(QQ群号：469733580) (3.001']}
        />
        <mesh
          castShadow
          receiveShadow
          geometry={nodes['Component2#1_12'].geometry}
          material={materials['设计师SING的模型专用贴图(QQ群号：469733580) (339)1']}
        />
        <mesh
          castShadow
          receiveShadow
        ...
        <mesh
          ...
          material={materials['设计师SING的模型专用贴图(QQ群号：469733580) (3.004']}
        />
        <mesh
          castShadow
          receiveShadow
        ...
        <mesh
          ...
          material={materials['设计师SING的模型专用贴图(QQ群号：469733580) (3.005']}
        />
        <mesh
          castShadow
          receiveShadow
          geometry={nodes['Component2#1_27'].geometry}
          material={materials['设计师SING的模型专用贴图(QQ群号：469733580) (339)7']}
        />
        <mesh
          castShadow
          receiveShadow
          geometry={nodes['Component2#1_28'].geometry}
          material={materials['设计师SING的模型专用贴图(QQ群号：469733580) (339)8']}
        />
        <mesh
          castShadow
          receiveShadow
          geometry={nodes['Component2#1_29'].geometry}
          material={materials['设计师SING的模型专用贴图(QQ群号：469733580) (3.002']}
        />
        <mesh
          castShadow
          receiveShadow
          geometry={nodes['Component2#1_30'].geometry}
          material={materials['设计师SING的模型专用贴图(QQ群号：469733580) (3.003']}
        />
      </group>
      ...
      <group
        ...
        <mesh
          ...
          material={materials['halo-contact-harvest-book-cover-final-10july072']}
        />
        <mesh
          castShadow
          receiveShadow
        ...
        >
          <meshPhysicalMaterial color={"gray"} emissive={"white"} emissiveIntensity={30} />
        </mesh>
        <mesh
          castShadow
          receiveShadow
      ...
      {/* Merdiven */}  
      <group position={[-2.079, 2.366, -2.298]} rotation={[0, 0, -Math.PI]} scale={-0.5}>
        <mesh
          castShadow
          receiveShadow
      ...
      {/* Dresser */}  
      <group position={[-2.074, 1.962, 0.663]} rotation={[0, Math.PI / 2, 0]} scale={0.025}>
        <mesh
          castShadow
          receiveShadow
      ...
      {/* Hamak */}  
      <group position={[2.9, 0.3, -0.848]} rotation={[0, Math.PI / 2, 0]} scale={0.017} >
        <mesh
          castShadow
          receiveShadow
      ...
      {/* Gym */}  
      <group position={[3.188, 1.877, -3.172]} rotation={[0, -1.571, 0]} scale={0.375} >
        <group position={[3.494, 0.022, -1.247]}>
          <group position={[0.2, 0.43, 0.062]} rotation={[0, 0, -Math.PI]} scale={-1}>
            <mesh
              castShadow
              receiveShadow
      ...
      <mesh castShadow receiveShadow geometry={nodes.Base_1.geometry} material={materials.Floor} >
      ...
      <mesh 
        ...
        material={materials.GrayWall}
      >
      <meshPhysicalMaterial color={"lightgray"} roughness={0.15} metalness={1} clearcoat={0.6}/>
      </mesh>
    </group>
    <Image url={logo} scale={.75} color="white" position={[0.235,2.5,3.75]} rotation={[0,Math.PI/2,0]} side={DoubleSide}/>
    </>
  )
}
const basePath = import.meta.env.VITE_BASE_URL === '/codesignweb/' ? '' : import.meta.env.VITE_BASE_URL;
