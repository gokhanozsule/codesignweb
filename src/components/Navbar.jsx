...
const Navbar = () => {
  return (
    <div className='w-full h-10 text-white flex justify-between border border-gray-400 items-center rounded-3xl z-30 custom-shadow'>
        ...
        <Link to="/codesignweb" ><div className='w-60 flex ml-10 items-center justify-center cursor-pointer'>
        ...
        <div className='mx-4 flex justify-center items-start gap-2 mr-'>
            <Link to='/codesignweb/Works' ><button className='rounded-xl p-1 cursor-pointer hover:scale-90 hover:bg-[#525253] transition-all'>Works</button></Link>
            <Link to='/codesignweb/About' ><button className='rounded-xl p-1 cursor-pointer hover:scale-90 hover:bg-[#525253] transition-all'>About</button></Link>
            <Link to='/codesignweb/Contact' ><button className='rounded-xl p-1 cursor-pointer hover:scale-90 hover:bg-[#525253] transition-all'>Contact</button></Link>
        </div>
    </div>
  )
}
